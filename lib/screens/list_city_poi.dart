...
class CityWeatherScreen extends StatefulWidget {
  CityWeatherScreen({this.weatherData, this.cityPOIDATA});
  final weatherData;
  final cityPOIDATA;
...
class _CityWeatherScreenState extends State<CityWeatherScreen> {
  ...
  void initState() {
    super.initState();
    updateUI(widget.weatherData, widget.cityPOIDATA);
  }

  void updateUI(dynamic weather, dynamic city_poi) {
    setState(() {
                  ...
                  children: <Widget>[
                    FlatButton(
                      onPressed: () async {
                        ...
                        var currCityPOI = await poi.getCityPOI("los angeles");
                        updateUI(currWeather, currCityPOI);
                      },
                      child: Icon(
                    ...
                    FlatButton(
                      onPressed: () async {
                        ...
                        if (cityName != null) {
                          ...
                          updateUI(currWeatherData, currCityPOI);
                        }
                      },
                      child: Icon(
